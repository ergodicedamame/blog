...
def compute_statistics(
  ...
  """
  Given the m*k length array holdind the scores for the m-repetitions of k-fols, will compute 
...
prob_model_1_better, prob_rope, prob_model_2_better = get_t_dist_posterior_probs(
...
probabilities = np.array([prob_model_1_better, prob_rope, prob_model_2_better])
