...
A better approach is to cluster the observations, and use the new ordering. 
This is what `sns.clustermap` offers, see [docs](https://seaborn.pydata.org/generated/seaborn.clustermap.html).

::: {.column-margin}
_Question:_ Is there another/better way to re-order the indices? 
I don't think anything purely algebraic would work, as the before and after objects are fundamentally different matrices.
:::
